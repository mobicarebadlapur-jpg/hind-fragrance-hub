...
REVOKE ALL ON FUNCTION public.confirm_paid_order(uuid,text,text,text,numeric) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.confirm_paid_order(uuid,text,text,text,numeric) FROM anon;
REVOKE ALL ON FUNCTION public.confirm_paid_order(uuid,text,text,text,numeric) FROM authenticated;
