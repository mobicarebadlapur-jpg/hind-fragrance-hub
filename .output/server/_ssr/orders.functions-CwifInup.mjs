import { c as createServerRpc, a as admin, d as demoPaymentAllowed, P as PAYMENTS_NOT_LIVE_MESSAGE, n as notify } from "./platform.server-CeaHE6Wt.mjs";
...
const placeOrder = createServerFn({
  ...
  if (itemsError) {
    ...
    return {
      ok: false,
      error: "Could not save the items in your order."
    };
  }
  return {
    ok: true,
