...
const appCss = "/assets/styles-DXWl8j8O.css";
...
async function logReferralClick(code, landingPage, visitorId) {
...
const $$splitComponentImporter$j = () => import("./index-CKR3LGkm.mjs");
...
const $$splitComponentImporter$h = () => import("./auth-BXfbnyQG.mjs");
...
const $$splitComponentImporter$g = () => import("./business-partner-BDgYnmoD.mjs");
const Route$g = createFileRoute("/business-partner")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$f = () => import("./cart-BPUzBYfq.mjs");
...
const $$splitComponentImporter$e = () => import("./checkout-CVgjvI6U.mjs");
...
const $$splitComponentImporter$d = () => import("./join-BhHYGn5a.mjs");
const Route$d = createFileRoute("/join")({
  head: () => ({
    meta: [{
      title: "Join as a Business Partner for ₹199 — Hind Fragrance"
    }, {
      name: "description",
      content: "Register as a Hind Fragrance Business Partner for ₹199 and submit your application for admin approval."
    }, {
      property: "og:title",
      content: "Join as a Business Partner — Hind Fragrance"
    }, {
      property: "og:description",
      content: "One-time ₹199 registration, followed by partner approval."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./privacy-DVIBP6Br.mjs");
const Route$c = createFileRoute("/privacy")({
  head: () => ({
    meta: [{
      title: "Privacy Policy — Hind Fragrance"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./refund-DtC3RVFi.mjs");
const Route$b = createFileRoute("/refund")({
  head: () => ({
    meta: [{
      title: "Return & Refund Policy — Hind Fragrance"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./shipping-BFeNnGEM.mjs");
const Route$a = createFileRoute("/shipping")({
  head: () => ({
    meta: [{
      title: "Shipping Policy — Hind Fragrance"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./shop-Dgy4Qbcx.mjs");
...
const $$splitComponentImporter$8 = () => import("./terms-3izUPXU9.mjs");
const Route$8 = createFileRoute("/terms")({
  head: () => ({
    meta: [{
      title: "Terms & Conditions — Hind Fragrance"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./account-2ipTnci9.mjs");
...
const $$splitComponentImporter$6 = () => import("./admin-B8bjmbw4.mjs");
const Route$6 = createFileRoute("/_authenticated/admin")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Manage Hind Fragrance partners, products and orders."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin-dashboard-CSrxYybR.mjs");
const Route$5 = createFileRoute("/_authenticated/admin-dashboard")({
  beforeLoad: async () => {
    const {
      data: userData
    } = await supabase.auth.getUser();
  ...
  head: () => ({
    meta: [{
      title: "Admin Dashboard — Hind Fragrance"
    }, {
      name: "description",
      content: "Financial and operational overview for Hind Fragrance."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin-payouts-BzQaVs7O.mjs");
const Route$4 = createFileRoute("/_authenticated/admin-payouts")({
  beforeLoad: async () => {
    const {
      data: userData
    } = await supabase.auth.getUser();
  ...
  head: () => ({
    meta: [{
      title: "Partner Payouts — Hind Fragrance"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin-refunds-BJZLOr4v.mjs");
const Route$3 = createFileRoute("/_authenticated/admin-refunds")({
  beforeLoad: async () => {
    const {
      data
    } = await supabase.auth.getClaims();
    if (!data?.claims?.sub) throw redirect({
      to: "/auth",
      search: {
    ...
    const {
      data: profile
    } = await supabase.from("profiles").select("role").eq("id", data.claims.sub).maybeSingle();
    if (profile?.role !== "admin") throw redirect({
      to: "/account"
    });
  },
...
const $$splitComponentImporter$2 = () => import("./partner-BvTx8Hal.mjs");
const Route$2 = createFileRoute("/_authenticated/partner")({
  head: () => ({
    meta: [{
...
const $$splitNotFoundComponentImporter = () => import("./product._slug-D_wVVLkA.mjs");
const $$splitComponentImporter$1 = () => import("./product._slug-DJIuDaw5.mjs");
...
const $$splitComponentImporter = () => import("../_orderId-8UdaqYDf.mjs");
const Route = createFileRoute("/_authenticated/orders/$orderId")({
  head: () => ({
    meta: [{
      title: "Order Details — Hind Fragrance"
    }]
  }),
...
const BusinessPartnerRoute = Route$g.update({
  id: "/business-partner",
...
const JoinRoute = Route$d.update({
  id: "/join",
  path: "/join",
  getParentRoute: () => Route$k
});
...
const RefundRoute = Route$b.update({
  id: "/refund",
  path: "/refund",
  getParentRoute: () => Route$k
});
const ShippingRoute = Route$a.update({
  id: "/shipping",
  path: "/shipping",
  getParentRoute: () => Route$k
});
...
const AuthenticatedAdminRoute = Route$6.update({
  id: "/admin",
  path: "/admin",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAdminDashboardRoute = Route$5.update({
  id: "/admin-dashboard",
  path: "/admin-dashboard",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAdminPayoutsRoute = Route$4.update({
  id: "/admin-payouts",
  path: "/admin-payouts",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedAdminRefundsRoute = Route$3.update({
  id: "/admin-refunds",
  path: "/admin-refunds",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedPartnerRoute = Route$2.update({
  id: "/partner",
  path: "/partner",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedOrdersOrderIdRoute = Route.update({
  id: "/orders/$orderId",
  path: "/orders/$orderId",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedAdminRefundsRoute,
