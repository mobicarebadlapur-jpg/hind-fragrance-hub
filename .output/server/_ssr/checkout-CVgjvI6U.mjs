...
import { u as useCart, g as getReferralCode, a as getReferralVisitorId } from "./router-BNTsyRpR.mjs";
import { i as inr } from "./format-BY29FUB1.mjs";
import { p as placeOrder, a as payForOrder } from "./orders.functions-dU58mwV4.mjs";
...
function Checkout() {
  ...
  if (placed) return /* @__PURE__ */ jsxRuntimeExports.jsx(PublicLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-md px-4 py-24 text-center", children: [
  ...
  if (items.length === 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(PublicLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-md px-4 py-24 text-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PublicLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-5xl gap-10 px-4 py-14 lg:grid-cols-[1fr_320px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "rounded-xl border border-border bg-card p-6", onSubmit: handleSubmit, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", size: "lg", className: "mt-6 w-full", disabled: busy, children: busy ? "Opening secure payment…" : `Pay ${inr(subtotal + shipping)}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-center text-xs text-muted-foreground", children: "Payments are verified server-side before the order is marked paid and stock is deducted." })
    ] }),
