...
import { s as supabase } from "./client-CUUoBMAc.mjs";
...
const appCss = "/assets/styles-Q_5qna6U.css";
...
const $$splitComponentImporter$f = () => import("./index-CEUOQPmJ.mjs");
...
const $$splitComponentImporter$d = () => import("./auth-Db_v8AOT.mjs");
...
const $$splitComponentImporter$c = () => import("./business-partner-fhbj-ZZi.mjs");
const Route$c = createFileRoute("/business-partner")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$b = () => import("./cart-bgeZ9gB_.mjs");
...
const $$splitComponentImporter$a = () => import("./checkout-AdvYhEVL.mjs");
...
const $$splitComponentImporter$9 = () => import("./join-DHUG5jaA.mjs");
...
const $$splitComponentImporter$8 = () => import("./privacy-BtHOtZW7.mjs");
...
const $$splitComponentImporter$7 = () => import("./refund-BDIeJbqH.mjs");
const Route$7 = createFileRoute("/refund")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$6 = () => import("./shipping-3mQaXC9K.mjs");
const Route$6 = createFileRoute("/shipping")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./shop-B449UF_U.mjs");
...
const $$splitComponentImporter$4 = () => import("./terms-C2WVj8m0.mjs");
...
const $$splitComponentImporter$3 = () => import("./account-CO3PbZ1k.mjs");
...
const $$splitComponentImporter$2 = () => import("./admin-CWCZ0Lvh.mjs");
...
const $$splitComponentImporter$1 = () => import("./partner-ClrWm2e8.mjs");
...
const $$splitNotFoundComponentImporter = () => import("./product._slug-B776ABRv.mjs");
const $$splitComponentImporter = () => import("./product._slug-DAYig5Zv.mjs");
...
const BusinessPartnerRoute = Route$c.update({
  id: "/business-partner",
...
const RefundRoute = Route$7.update({
  id: "/refund",
  path: "/refund",
  getParentRoute: () => Route$g
});
const ShippingRoute = Route$6.update({
  id: "/shipping",
  path: "/shipping",
  getParentRoute: () => Route$g
});
