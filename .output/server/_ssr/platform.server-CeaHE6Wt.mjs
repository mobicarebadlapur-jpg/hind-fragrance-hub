import { T as TSS_SERVER_FUNCTION } from "./server-06s_y05T.mjs";
...
async function demoPaymentAllowed(userId) {
...
const PAYMENTS_NOT_LIVE_MESSAGE = "Online payments are not active yet. Please contact us to complete this order.";
...
export {
  PAYMENTS_NOT_LIVE_MESSAGE as P,
  admin as a,
  audit as b,
  createServerRpc as c,
  demoPaymentAllowed as d,
  availableBalance as e,
  getSetting as g,
  isAdmin as i,
  notify as n,
  sha256 as s
