import { c as createServerRpc, g as getSetting, a as admin, d as demoPaymentAllowed, P as PAYMENTS_NOT_LIVE_MESSAGE, n as notify } from "./platform.server-CeaHE6Wt.mjs";
...
const verifyMembershipPayment = createServerFn({
  ...
  if (payment.demo_mode) {
    if (!await demoPaymentAllowed(context.userId)) return {
      ok: false,
      error: PAYMENTS_NOT_LIVE_MESSAGE
    };
  } else {
